#!/usr/bin/env python3
"""
e150_gpt2_switch_compute_fork_e147.py
...
def generate_matmul_packets(
    ...
    # e150: More aggressie input scaling to reduce packet count
...
...[output truncated. This is the end of the output]...
    ...
    ✓ Mean=18.166, Std=18.480

  FFN DOWN projection (with residual):
    Packets: 905526 + 11200 residual = 916726
  Using DPDK for 916726 packets...
  DPDK output: DPDK initialized successfully!
Sending 916726 packets...

Results:
  Packets sent: 916726
  Time:         83.424 ms
  PPS:          10988726 (11.0M pps)
  Throughput:   5.63 Gbps

    ✓ Mean=-7.284, Std=27.024

✓ Layer 10 complete
  Layer 10 time: 20.59s
...
================================================================================
  ...
  PARALLEL Q, K, V projections:
    ...
    K: 1684477 packets
    V: 1684477 packets
    Total: 5053431 packets
  Using DPDK for 1684477 packets...
  DPDK output: DPDK initialized successfully!
Sending 1684477 packets...

Results:
  Packets sent: 1684477
  Time:         150.936 ms
  PPS:          11160174 (11.2M pps)
  Throughput:   5.71 Gbps
...
Results:
  Packets sent: 1684477
  Time:         152.670 ms
  PPS:          11033470 (11.0M pps)
  Throughput:   5.65 Gbps
...
Results:
  Packets sent: 1684477
  Time:         150.722 ms
  PPS:          11176077 (11.2M pps)
  Throughput:   5.72 Gbps

    Reading counters...
    ✓ Q: mean=9.833, std=30.401
    ✓ K: mean=9.833, std=30.401
    ✓ V: mean=9.833, std=30.401
    Send time: 2.310s, Read time: 2.330s

  O projection (with residual):
    Packets: 30537 + 3584 residual = 34121
  Using DPDK for 34121 packets...
  DPDK output: DPDK initialized successfully!
Sending 34121 packets...

Results:
  Packets sent: 34121
  Time:         3.380 ms
  PPS:          10093899 (10.1M pps)
  Throughput:   5.17 Gbps

    ✓ Mean=-13.490, Std=29.482

  FFN UP projection:
    Packets: 1031336
  Using DPDK for 1031336 packets...
  DPDK output: DPDK initialized successfully!
Sending 1031336 packets...

Results:
  Packets sent: 1031336
  Time:         92.017 ms
  PPS:          11208097 (11.2M pps)
  Throughput:   5.74 Gbps

    ✓ Mean=18.476, Std=37.666

  FFN DOWN projection (with residual):
    Packets: 23368 + 3392 residual = 26760
  Using DPDK for 26760 packets...
  DPDK output: DPDK initialized successfully!
Sending 26760 packets...

Results:
  Packets sent: 26760
  Time:         2.699 ms
  PPS:          9913213 (9.9M pps)
  Throughput:   5.08 Gbps

    ✓ Mean=-15.052, Std=35.913

✓ Layer 11 complete
  Layer 11 time: 19.60s

================================================================================
ALL 12 LAYERS COMPLETE!
================================================================================
  Total time: 297.73s
  Average per layer: 24.81s
  Final hidden state: mean=-15.052, std=35.913
...
================================================================================
  ...
  Stage 2: Switch fine-pass (simulated - using CPU result)
    ...
    Result: Same as CPU (token=1484, logit=461.1)

================================================================================
RESULT: Next token = 1484 (logit=461.1)
================================================================================
